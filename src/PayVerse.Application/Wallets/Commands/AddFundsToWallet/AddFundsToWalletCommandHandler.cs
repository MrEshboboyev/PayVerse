...
internal sealed class AddFundsToWalletCommandHandler(
    IWalletRepository walletRepository,
    IUnitOfWork unitOfWork) : ICommandHandler<AddFundsToWalletCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = wallet.AddFunds(amountResult.Value, description);
